<template>
	<header class="bg-darkest header">
		<g-link to="/#main" class="logo">{{ $static.metadata.siteName }}</span></g-link>
		<div class="nav-wrapper">
			...
			<nav class="nav">
				...
				<g-link to="/design-process/#main" class="nav__link"
					>Design Process</g-link
				>
				<g-link to="/project-listing/#main" class="nav__link">Work</g-link>
				<g-link to="/blog-listing/#main" class="nav__link">Blog</g-link>
				<a
					href="#"
					v-scroll-to="'#contact'"
					class="nav__link"
