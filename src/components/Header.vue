  ...
  <header class="bg-darkest sticky-top">
    <div class="header page-padding">
      ...
      <div class="menu-wrapper">
        <button type="button" v-on:click="toggleMenu()" class="menu-toggle mob-only">menu</button>
        <nav class="nav menu">
          <g-link to="/about/" class="nav__link">About</g-link>
          <g-link to="/design-process/" class="nav__link">Design Process</g-link>
          <g-link to="/project-listing/" class="nav__link">Work</g-link>
          <g-link to="/blog-listing/" class="nav__link">Blog</g-link>
          <a href="#" v-scroll-to="'#contact'" class="nav__link" v-on:click="toggleMenu()">Contact</a>
        </nav>
      </div>
    </div>
  </header>
